...
namespace Project_1.Migrations
{
    ...
    public partial class SeedCategories : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    Slug_name = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Products_Categories_ID_danhmuc",
                        column: x => x.ID_danhmuc,
                        principalTable: "Categories",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Products_Tags_ID_tag",
                        column: x => x.ID_tag,
                        principalTable: "Tags",
                        principalColumn: "Id");
                })
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Products_ID_danhmuc",
                table: "Products",
                column: "ID_danhmuc");

            migrationBuilder.CreateIndex(
                name: "IX_Products_ID_tag",
                table: "Products",
                column: "ID_tag");
